...
const SetPrice = () => {
  ...
  const borderTwo = useColorModeValue('brand.500', 'tan.500');
  const tokenListTriggerColor = useColorModeValue('brand.400', 'brand.400');
  const tokenListTrgiggerBgColor = useColorModeValue('brand.400', 'brand.400');
  const balanceColor = useColorModeValue('gray.600', 'brand.400');
        ...
        {isMobileDevice ? (
          ...
          <>
            ...
            <Box
              ...
              <Box display="flex" justifyContent="space-between" alignItems="center" mb={5}>
                <Text color={balanceColor} fontSize="14x">
                  Balance: 2.2332 USDT
                </Text>
                <Menu>
                    <Button
