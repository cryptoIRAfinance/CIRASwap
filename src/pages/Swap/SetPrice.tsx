...
const SetPrice = () => {
  ...
  const borderColor = useColorModeValue('brand.50', 'brand500');
  const iconColor = useColorModeValue('gray.400', 'brand.100');
  const textColorOne = useColorModeValue('gray.600', 'brand.50');
  const lightmode = useColorModeValue(true, false);
  const buttonBgcolor = useColorModeValue('brand.50', 'brand.400');
  const color = useColorModeValue('brand.200', 'brand.500');
