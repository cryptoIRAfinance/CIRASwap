...
export default function AddLiquidity({
  ...
  const infoBg = useColorModeValue("brand.50", "brand.100");
  const genBorder = useColorModeValue("brand.400", "brand.400");
  const bgColor = useColorModeValue("brand.50", "brand.400");
  const topIcons = useColorModeValue("brand.500", "brand.500");
  const textColorOne = useColorModeValue("brand.50", "brand.50");
  const btnTextColor = useColorModeValue("brand.50", "brand.500");
  const approveButtonBgColor = useColorModeValue("brand.500", "tan.500");
  const approveButtonColor = useColorModeValue("brand.50", "brand.50");

  const { independentField, typedValue, otherTypedValue } = useMintState();
  //const [loading, setLoading] = useState(false);
  const [run, setRun] = useState(false);
  const bgColorRide = useColorModeValue("brand.500", "tan.500");
