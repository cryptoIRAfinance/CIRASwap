...
const Remove = () => {
  ...
  const topIcons = useColorModeValue("brand.500", "brand.50");
  const titleColor = useColorModeValue("brand.500", "brand.400");
  const positionBgColor = useColorModeValue("brand.100", "brand.500");
  const positiontextColor = useColorModeValue("gray.600", "brand.400");
  const pairTextColor = useColorModeValue("gray.800", "brand.50");
  const pairinformationBgColor = useColorModeValue("brand.50", "brand.600");
  const pairinformationBorderColor = useColorModeValue("brand.300", "brand.500");
  const approveButtonColor = useColorModeValue("brand.50", "brand.50");
  const WithdrawalButtonColor = useColorModeValue("brand.50", "brand.50");
  const approveButtonBgColor = useColorModeValue("brand.400", "brand.400");
  const withdrawaButtonBgColor = useColorModeValue("brand.400", "brand.400");
  const hoverwithdrawaButtonBgColor = useColorModeValue("brand.500", "brand.500");
  const inActiveApproveButtonBgColor = useColorModeValue("brand.300", "brand.300");
  const inActiveApproveButtonColor = useColorModeValue("brand.300", "brand.300");
  const approvedButtonColor = useColorModeValue("brand.400", "brand.400");
  const approvedButtonBgColor = useColorModeValue("brand.400", "brand.400");
  const approvedButtonBorderColor = useColorModeValue("brand.300", "brand.300");
