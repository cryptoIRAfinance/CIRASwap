...
const ShowYieldFarmDetails = ({
  ...
  const bgColor = useColorModeValue("#FFF", "brand.800");
  const modalTextColor = useColorModeValue("gray.700", "brand.50");
  const modalTextColor2 = useColorModeValue("gray.500", "brand.50");
  ...
  const bgColor2 = useColorModeValue("brand.400", "tan.500");
    ...
    <>
      ...
      {Number(content.poolVersion) === 2 ? (
        <Flex
          ...
          background={mode === DARK_THEME ? "#394637" : "#F2F5F8"}
          padding='0 20px'
          paddingBottom='4px'
          border={
            mode === DARK_THEME ? "2px solid brand.500" : "2px solid #DEE6ED"
          }
          width='100%'
        >
          <Box
          ...
          >
            <Box>
              <Flex my={2} justify={{ base: "center", md: "none", lg: "none" }}>
                ...
                <Text
                  fontSize='16px'
                  color={mode === DARK_THEME ? "#9cb099" : "#333333"}
                >
              ...
              <Flex marginLeft={{ base: "20px", md: "none", lg: "none" }}>
                <Button
                  ...
                  h='40px'
                  borderRadius='6px'
                  bg={mode === DARK_THEME ? "tan.500" : "brand.500"}
                  color={mode === DARK_THEME ? "brand.50" : "brand.50"}
                  border='0'
                  mb='4'
                  mr='6'
                  disabled={
            ...
            {isMobileDevice ? (
              <Box width='60%' margin='0 auto'>
                <Flex my={2}>
                  <Text
                    fontSize='20px'
                    color={mode === DARK_THEME ? "brand.50" : "gray.700"}
                    marginRight='10px'
                    textAlign='center'
                    fontWeight='bold'
                  >
                  ...
                  <Text color={mode === DARK_THEME ? "brand.600" : "gray.700"}>
                    CIRA Earned
                  </Text>
                </Flex>
                <Button
                  ...
                  margin='0 auto'
                  borderRadius='6px'
                  bg={mode === DARK_THEME ? "brand.400" : "brand.400"}
                  color={mode === DARK_THEME ? "brand.50" : "brand.50"}
                  border='0'
                  mb='4'
                  mr='2'
              ...
              <Box margin='0 auto'>
                <Flex my={2}>
                  ...
                  <Text color={mode === DARK_THEME ? "#9cb099" : "#333333"}>
                    RGP Earned
                  </Text>
                </Flex>
                <Button
                  ...
                  margin='0 auto'
                  borderRadius='6px'
                  bg={mode === DARK_THEME ? "brand.400" : "#999999"}
                  color={mode === DARK_THEME ? "brand.50" : "brand.50"}
                  border='0'
                  mb='4'
                  mr='2'
