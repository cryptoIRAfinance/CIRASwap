      ...
      if (Number(chainId) === Number(SupportedChainId.POLYGONTEST)) {
        ...
        dispatch(
          updateTotalLiquidity([
            ...
            {
              deposit: "CIRA-USDC", //await deposit(pool3.token0, pool3.token1),
              liquidity: USDC_RGPLiq,
              apy: calculateApy(rgpPrice, USDC_RGPLiq, 1050),
            },
            {
      ...
      if (
        ...
        dispatch(
          updateTokenStaked([
            ...
            { staked: 0, earned: 0 },
            { staked: 0, earned: 0 },
            { staked: RGPStakedV2, earned: RGPEarnedV2, symbol: "CIRA" },
          ])
        );
        ...
        dispatch(
          updateTokenStaked([
            { staked: RGPStaked, earned: RGPEarned, symbol: "CIRA" },
            {
              staked: formatBigNumber(poolTwoStaked.amount),
              earned: formatBigNumber(poolTwoEarned),
            },
    ...
    <Box>
      ...
      {!showAlert || tabIndex === 0 || tabIndex === 2 ? null : tabIndex === 1 &&
        ...
        <Box mx={[5, 10, 15, 20]} my={4}>
          <Alert
            color='tan.50'
            background={mode === DARK_THEME ? "brand.400" : "brand.400"}
            borderRadius='8px'
          >
            <AlertSvg />
            <AlertDescription
        ...
        <Box mx={[5, 10, 15, 20]} my={4}>
          <Alert
            color='tan.50'
            background={mode === DARK_THEME ? "brand.500" : "brand.500"}
            borderRadius='8px'
          >
            <AlertSvg />
            <AlertDescription
        ...
        <Flex justifyContent='space-between' mt={10}>
          <TabList h={isMobileDevice ? undefined : 14} borderBottom={0}>
            <Tab
              ...
              // padding={0}
              border='1px solid brand.400 !important'
              background={
              ...
              >
                <Box mx='auto' w={["100%", "100%", "100%"]} pb='70px'>
                  <Flex
                    ...
                    border={
                      mode === LIGHT_THEME
                        ? "1px solid brand.200 !important"
                        : mode === DARK_THEME
                        ? "1px solid brand.500 !important"
                        : "1px solid brand.500"
                    }
