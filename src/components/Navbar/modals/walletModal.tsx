...
const WalletModal: React.FC<IModal> = ({
  ...
  const borderColor = useColorModeValue("brand.50", "brand.500");
  const dashedColor = useColorModeValue("brand.50", "brand.400");
  const activeButtonColor = useColorModeValue("brand.500", "tan.500");
  const buttonColor = useColorModeValue("brand.400", "brand.400");
        ...
        >
          ...
          >
            ...
            >
              ...
              <Tooltip hasArrow label={hasCopied ? "Copied!" : "Copy"} bg="brand.400" color="black">
            ...
            <Box>
              <Flex
                ...
                <Button
                  ...
                  isFullWidth
                  _hover={{ background: `${activeButtonColor}`, color: "brand.50" }}
                ...
                <Button
                  border={`1px solid ${activeButtonColor}`}
                  box-sizing="border-box"
                  box-shadow="0px 1px 7px -2px rgba(80, 99, 77, 0.06), 0px 2px 2px rgba(80, 99, 77, 0.06)"
                  border-radius="6px"
                  padding="23px 0"
                  color={activeButtonColor}
                  _hover={{ background: `${activeButtonColor}`, color: "brand.50" }}
