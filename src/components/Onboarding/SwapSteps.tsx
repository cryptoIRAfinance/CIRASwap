...
export const tourSteps = [
  ...
  },
  {
    ...
    content: <ContentBox>This is the DApps dropdown, it is used to navigate to other DApps on CIRA network</ContentBox>,
  ...
  {
    target: '.HeaderRide',
    title: <TitleBox>CIRASwap</TitleBox>,
    content: <ContentBox>These links lead to individual dapps provided by Crypto IRA.</ContentBox>,
    placement: "left-end",
    locale: {
      next: <NextBtn />,
      back: <BackBtn />,
...

  {
    ...
    content: <ContentBox>This shows the networks supported by Crypto IRA. More to come.</ContentBox>,
    locale: {
      next: <NextBtn />,
      back: <BackBtn />,
      close: <CloseBtn />,
